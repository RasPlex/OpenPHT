...
bool CProcessorHD::Render(CRect src, CRect dst, IDirect3DSurface9* target, IDirect3DSurface9** source, DWORD flags, UINT frameIdx)
{
  ...
  ApplyFilter( DXVAHD_FILTER_BRIGHTNESS, g_settings.m_currentVideoSettings.m_Brightness
                                             , 0, 100, 50);
  ApplyFilter( DXVAHD_FILTER_CONTRAST, g_settings.m_currentVideoSettings.m_Contrast
                                             , 0, 100, 50);
